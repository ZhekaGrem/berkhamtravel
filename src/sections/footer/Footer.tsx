      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.contact}>
            ...
            <div className={styles.contactInfo}>
              ...
              <p>London, E1 0SG</p>
              <a href="tel:+33679105270">+33 679 105 270</a>
              <a href="mailto:office@berkhamtravel.com">office@berkhamtravel.com</a>
            </div>
          </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {currentYear} Berkham Private Travel & Concierge LLP. All rights reserved.
          </p>
